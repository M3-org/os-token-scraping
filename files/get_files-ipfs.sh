...
# This script will download the URLs in columns 2 and 3 of sandboxAssets-ipfs.csv
...
# Ensure that the sandboxAssets-ipfs.csv file is in the same directory as the script
if [ ! -f sandboxAssets-ipfs.csv ]; then
  echo "sandboxAssets-ipfs.csv not found in the current directory"
  exit 1
fi
